...
export const articles: Article[] = [
  ...
  },
  {
    ...
    desc: "ETF fond za poplatek 0,05–0,22 % ročně zkopíruje vývoj celého světového trhu. Vysvětluji, jak začít, kde koupit a jak využít český daňový časový test — teď bez limitu 100 000 Kč.",
    descEn: "An ETF mirrors the entire global market for a fee of 0.05–0.22% per year. I explain how to start, where to buy, and how to use the Czech three-year tax exemption — now without the CZK 100,000 cap.",
    date: "13. května 2026",
    dateEn: "May 13, 2026",
    author: "Adam Dvořák, EFA",
  },
